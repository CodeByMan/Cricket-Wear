    ...
    <div className="privacy-policy-container">
     <MetaData title={"Privacy Policy"} />
      <div className="container___">
        <h1>Privacy Policy of Cricket Wear</h1>
        <p style={{ fontSize: "16px", fontWeight: "600" }}>
          {" "}
          Effective Date: 23-12-2021
        </p>
        <p>
          At Cricket Wear, we value the privacy of our customers and are
        ...
        <p>
          By using the Cricket Wear website and services, you agree to the
