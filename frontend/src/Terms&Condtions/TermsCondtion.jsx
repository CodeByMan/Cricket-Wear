  ...
  return (
    <div className="terms-container">
      ...
      <div className="terms-content">
        <p>
          Thank you for shopping with Cricket Wear! We appreciate your business
        ...
        <p>
          ...
          agreed to in writing by Cricket Wear.
        </p>
        <h2>Orders</h2>
        <p>
          All orders are subject to Cricket Wear's acceptance. We may refuse to
        ...
        <p>
          ...
          Cricket Wear. Prices displayed on the website exclude shipping
          ...
          from those in physical stores that stock Cricket Wear products. We
        ...
        <p>
          ...
          taxes, except for those based on Cricket Wear's income. If
          Cricket Wear is required to collect and pay taxes on Customer's
        ...
        <p>
          ...
          order without Cricket Wear's written consent. You may return products
        ...
        <p>
          You agree to indemnify and hold Cricket Wear harmless from any
          claims, costs, proceedings, losses, or demands arising from your
          breach of these Terms or anyone using your account.
        </p>
        <h2>Entire Agreement</h2>
        <p>
          These Terms constitute the entire agreement between Cricket Wear and
