        ...
        <div className={classes.payemntPage}>
          ...
          <div className={classes.paymentPage__container}>
                ...
                <Grid container spacing={2} className={classes.cardDetails}>
                  ...
                  <Grid item xs={12} container justifyContent="space-between">
                    <Grid item className={classes.icons}>
                      <img src={MasterCard} alt="MasterCard" style={{ width: "5%", height: "auto" }} />
                      <img src={Visa} alt="Visa" style={{ width: "5%", height: "auto" }} />
                      <img src={Paytm} alt="Paytm" style={{ width: "5%", height: "auto" }} />
                    </Grid>
                  </Grid>
                  <Grid item xs={6}>
                    <Typography
            ...
            <div className={classes.payemntAmount}>
              ...
              <div className={classes.shipping_Details}>
