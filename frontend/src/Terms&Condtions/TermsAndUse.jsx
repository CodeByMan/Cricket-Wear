    ...
    <div className="privacy-policy-container">
      ...
      <div className="container___">
        ...
        <p>
          ...
          experience purchasing from our webstore, CricketWear.com.
        </p>
        <p>
        ...
        <p>
          You (“Customer”) may place orders for Products with Cricket Wear
          ...
          agreed to or set forth in writing by Cricket Wear, any term or
        ...
        <h2>Orders</h2>
        <p>
          All orders are subject to Cricket Wear's acceptance. This means
          Cricket Wear may, for any reason, refuse to accept or may cancel or
          ...
          cancel an order after you have already been charged, Cricket Wear
        ...
        <p>
          ...
          and it is accepted by Cricket Wear. Prices for products displayed on
          ...
          website may differ from those in stores that stock Cricket Wear
          products, as these stores are independent of Cricket Wear.
          Cricket Wear reserves the right to amend pricing for any pricing
          ...
          submitted an online order, Cricket Wear will notify you of the error
        ...
        <p>
          ...
          Cricket Wear reserves the right to change or discontinue such offers
          at any time.
        </p>
        <h2>Taxes</h2>
        <p>
          The prices quoted for the products sold hereunder include applicable
          taxes. Customer shall pay, and reimburse Cricket Wear if it pays, any
          taxes, except for those based on Cricket Wear's income.
        </p>
        <h2>Payment</h2>
        <p>
        ...
        <p>
          ...
          process. Any timeframe provided by Cricket Wear for when the
          ...
          are beyond our control. Cricket Wear cannot be held liable for late
        ...
        <h2>Returns</h2>
        <p>
          Once an order has been placed and accepted by Cricket Wear, customer
          may not cancel such accepted order without Cricket Wear’s prior
          ...
          expenses. The product(s) must be returned to Cricket Wear within
        ...
        <p>
          ...
          indemnify and hold Cricket Wear harmless from and against any and all
        ...
        <p style={{ fontWeight: "500" }}>Cricket Wear</p>
        <p style={{ fontWeight: "500" }}>123 Main Street, City, Country</p>
        <p style={{ fontWeight: "500" }}>
          Email:{" "}
          <span style={{ fontWeight: "400" }}>info@cricketwear.com</span>
        </p>
      </div>
    </div>
  );
